...
URBANSOUND_AUDIO_DIR = "sound_datasets/urbansound8K/audio"  
URBANSOUND_META_PATH = "sound_datasets/urbansound8K/metadata/UrbanSound8K.csv"  
...
meta = pd.read_csv(URBANSOUND_META_PATH)
labels = sorted(meta['class'].unique())
...
print("🔍 Running inference on UrbanSound8K...")
...
print(f"\n🎯 Zero-Shot Accuracy on UrbanSound8K: {acc * 100:.2f}%")
